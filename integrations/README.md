...
> Warn Will when a kitchen or dining-area light has remained on while Frigate has continuously reported no person. This automation is advisory and never changes lights or automations itself. Holiday presence simulation and Visitor Mode suppress the alert, because those lights may be turned on deliberately while normal occupancy automations are disabled.
...
<details><summary><code>/remote/bedroom-remote/arrow-right-click</code></summary>

**Entity ID: `automation.remote_bedroom_remote_arrow_right_click`**

> *No description provided*

- Alias: /remote/bedroom-remote/arrow-right-click
- ID: `remote_bedroom_remote_arrow_right_click`
- Mode: `single`

File: [`automation/remote/bedroom_remote/arrow_right_click.yaml`](entities/automation/remote/bedroom_remote/arrow_right_click.yaml)
</details>
